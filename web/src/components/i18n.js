...
export const STR = {
  en: {
    ...
    seeHeatIntro: (d) =>
      `Two views of <b>this heatwave</b>, placed in different climates: <i>how hot</i> its worst day gets, and <i>how often</i> a day that hot happens — both anchored to this event, <b>not an average summer</b>. The slider asks what an extreme <i>as rare as June 2026</i> would look like in each climate. On the France-wide average, a comparable heatwave runs about <b>+${d.d2} °C</b> hotter at <b>+2 °C</b> of global warming and about <b>+${d.d3} °C</b> at <b>+3 °C</b>, relative to today. Drag the slider toward a hotter future, and use the tabs to switch views.`,
  ...
  fr: {
    ...
    seeHeatIntro: (d) =>
      `Deux vues de <b>cette canicule</b>, replacées dans différents climats : <i>à quel point</i> son pire jour est chaud, et <i>à quelle fréquence</i> un jour aussi chaud survient — les deux rapportées à cet événement, <b>pas à un été moyen</b>. Le curseur montre à quoi ressemblerait un extrême <i>aussi rare que juin 2026</i> dans chaque climat. Sur la moyenne nationale, une canicule comparable serait environ <b>+${d.d2} °C</b> plus chaude dans un monde à <b>+2 °C</b> et environ <b>+${d.d3} °C</b> à <b>+3 °C</b>, par rapport à aujourd'hui. Faites glisser le curseur vers un futur plus chaud, et utilisez les onglets pour changer de vue.`,
